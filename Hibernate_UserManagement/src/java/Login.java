...
public class Login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		Session session = sf.openSession();
                ...
                user = (User) session.createQuery("FROM User U WHERE U.email = :userName").setParameter("userName", uemail).uniqueResult();
                 if (user != null && user.getPassword().equals(pass)) {
                     out.print("Login SucessFully");
                             HttpSession s=request.getSession();  
                             s.setAttribute("uname",uemail);  
                     ...
                     out.print("Please Check Your Password and Email");
                 }
                }
                catch(Exception e){
                    out.print(e);
